...
var DayObject = {
    ...
    addCounts: function (counts) {
        this.countArray = counts;
    },
    returnActions: function() {
        return this.actionArray;
    },
    returnCounts: function() {
...
function textToObjects(text) {
    ...
    dateArray = objectsToArrays();
    actionCountArrays = joinActionsAndCounts();
    visualize(dateArray);
    //dataToArrays();
    //printAllDates();
...
function objectsToArrays() {
    ...
    dayObjects.forEach(function (x) {
        ...
        var actionsAndCounts = countActions(x.showArray(), x.describe());
        x.addAction(actionsAndCounts[0]);
        x.addCounts(actionsAndCounts[1]);
    });
    return dateArray;
}
...
function joinActionsAndCounts() {

    dayObjects.forEach(function (x) {

        console.log(x.returnActions());
